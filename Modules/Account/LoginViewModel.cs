...
//https://www.cnblogs.com/sqwh-ww/p/14386439.html
//https://blog.csdn.net/lweiyue/article/details/88885254
//https://yuezhizizhang.github.io/wpf/xaml/placeholder/2017/03/10/wpf-textbox-placeholder.html
...
namespace Aksl.Modules.Account.ViewModels
{
    public class LoginViewModel : BindableBase, IDataErrorInfo, INavigationAware
    {
        ...
        //private Infrastructure.MenuItem _currentMenuItem;
        //private object _activeView = default;
        //private object _selectedHamburgerMenuItem = default;
        #endregion
        ...
        private async Task ExecuteLoginCommandAsync()
        {
            ...
            try
            {
                ...
                Application.Current.Dispatcher.Invoke(() =>
                {
                    ...
                    //{
                    //   {"CurrentMenuItem",_navToParameter.CurrentMenuItem}
                    // };

                    // _regionManager.RequestNavigate(RegionNames.HamburgerMenuSideBarWorkspaceRegion, _navToParameter.ViewName, navigationParameters);
                });
        ...
        //        //if (_navToParameter.ActiveView is not null)
        //        //{
        //        //    var activeViewName = _navToParameter.ActiveView.GetType().Name;

        //        //    (string UserName, bool IsSuccessful, Infrastructure.MenuItem CurrentMenuItem, object SelectedMenuItem,object PreviewSelectedItem) navFromParameter = (UserName,IsSuccessful, _navToParameter.CurrentMenuItem, _navToParameter.SelectedItem ,_navToParameter.PreviewSelectedItem);

        //        //    //NavigationParameters navigationParameters = new()
        //        //    //{
        //        //    //     { "UserName",UserName },
        //        //    //     { "IsSuccessful", IsSuccessful},
        //        //    //      {"SelectedHamburgerMenuItem", _selectedHamburgerMenuItem}
        //        //    //};

        //        //    NavigationParameters navigationParameters = new()
        //        //    {
        //        //         { "NavFromParameter",navFromParameter},
        //        //    };

        //        //    _regionManager.RequestNavigate(RegionNames.ShellContentRegion, activeViewName, navigationParameters);

        //        //   // contentRegion.Activate(_navToParameter.ActiveView);
        //        //}
        //    }
        //}
        ...
        public void NavigatedBack()
        {
            ...
            if (contentRegion is not null)
            {
                if (_navToSignInParameter.ActiveView is not null)
                {
                    ...
                    // (string UserName, bool IsSuccessful, Infrastructure.MenuItem CurrentMenuItem, object SelectedHamburgerMenuItem, object PreviewSelectedHamburgerMenuItem) navFromParameter = (UserName, IsSuccessful, _navToParameter.CurrentMenuItem, _navToParameter.SelectedHamburgerMenuItem, _navToParameter.PreviewSelectedHamburgerMenuItem);
        ...
        {
            //_currentMenuItem = navigationContext.Parameters["CurrentMenuItem"] as Infrastructure.MenuItem;
            //_activeView = navigationContext.Parameters["ActiveView"];
            //_selectedHamburgerMenuItem = navigationContext.Parameters["SelectedHamburgerMenuItem"];
            ...
            // var navParameter = navigationContext.Parameters["NavToParameter"];
        }
